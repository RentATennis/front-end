...
const ContractModal = () => {
  const { currentProduct, contractModal, setContractModal, handleContractModal } =
    ...
    <StyledContractModal>
      <div className="contractModal__container">
        ...
        <div className="contractModal__Content">
            ...
            <p>O locador concorda em alugar um par de tênis {currentProduct?.name}, da {`${currentProduct?.brand}`} para o locatário pelo período de {} dias.</p>
            <p></p>
            ...
            <p></p>
            <p>Eu {user?.user.name}</p>
        </div>
        <div className="contractModal__Buttons">
          <button className="contractConfirm__btn" onClick={() => {}}>
            Alugar
          </button>
          <div
